...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		<div>
			...
			<br/>
			<?php echo ('<a href="https://www.facebook.com/minskaidentificacoespet" target="_blank" style="color:#6d6d6d;"><img src="https://www.facebook.com/images/fb_icon_325x325.png" width="20px" style="display:inline; vertical-align:middle;"> /minskaidentificacoespet</a>'); ?>
			<br/>
			<?php echo ('<img src="https://d30y9cdsu7xlg0.cloudfront.net/png/12462-200.png" width="20px" style="display:inline; vertical-align:middle;"> contato@minska.com.br'); ?>
			<br/>
			<?php echo ('<img src="https://logodownload.org/wp-content/uploads/2015/04/whatsapp-logo-icone.png" width="20px" style="display:inline; vertical-align:middle;"> (11)98817-9900'); ?>
			<?php if ( apply_filters( 'storefront_credit_link', true ) ) { ?>
			<?php } ?>
		</div>
		<div style="text-align:center; color: #d9d9d9; margin: 20px 0 0 0;">
			<?php echo ('Desenvolvido por Yasmin Sayad Yoshizumi'); ?>
		</div>
		<?php
	}
}
